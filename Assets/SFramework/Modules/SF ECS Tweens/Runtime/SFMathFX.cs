...
namespace SFramework.ECS.Runtime.Tweens.SFramework.Modules.SF_ECS_Tweens.Runtime
{
    public static class SFMathFX
    {
        //Ease in out
        ...
        {
            return new Vector2(Lerp(start.x, end.x, value), Lerp(start.y, end.y, value));
        }

        public static Vector3 Lerp(Vector3 start, Vector3 end, float value)
        {
            return new Vector3(Lerp(start.x, end.x, value), Lerp(start.y, end.y, value), Lerp(start.z, end.z, value));
        }
